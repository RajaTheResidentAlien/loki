...
function mpwrit(nam)                                 --Master preset write
  ...
  for i=1,4 do
    mwritab["S"..i.."_PlyPgCh"]=params:get("S"..i.."_PlyPgCh") mwritab["S"..i.."_SttPgCh"]=params:get("S"..i.."_SttPgCh")
    mwritab["S"..i.."_RctPgCh"]=params:get("S"..i.."_RctPgCh") mwritab["S"..i.."_RlnPgCh"]=params:get("S"..i.."_RlnPgCh")
...
function mpread(nam)                                  --Master preset read
  ...
  if err==nil then
    ...
    for i=1,4 do
      params:set("S"..i.."_PlyPgCh",mreadtab["S"..i.."_PlyPgCh"]) params:set("S"..i.."_SttPgCh",mreadtab["S"..i.."_SttPgCh"])
      params:set("S"..i.."_RctPgCh",mreadtab["S"..i.."_RctPgCh"]) params:set("S"..i.."_RlnPgCh",mreadtab["S"..i.."_RlnPgCh"])
...
params:add_group("PgCh_Grp","MIDIProgChAssign_Group",103)  --
...
for i=1,4 do
  ...
  params:add_number("S"..i.."_SttPgCh", "S"..i.."_StutterPrgCh",0,127,32+i)
  params:add_number("S"..i.."_RctPgCh", "S"..i.."_RandomCutoffPrgCh",0,127,104+i) 
...
for i=1,6 do                                                                                        --SoftCut Voices 1 thru 6
  ...
  params:add_number("V"..i.."LFOPgCh", "V"..i.."LFOPrgCh", 0, 127, (10*i)+32)
  ...
  if d.type == "program_change" then
    if lrn>0 then            --MIDI-learn of program change
      if page==1 then
        ...
        elseif ((sel>15) and (sel<20)) then params:set("S"..(sel-15).."_SttPgCh",d.val)
        end
      elseif page==3 then
      ...
      for i=1,4 do
        ...
        elseif d.val==params:get("S"..i.."_SttPgCh") then params:set("S"..i.."_Stt",1-params:get("S"..i.."_Stt"))
        elseif d.val==params:get("S"..i.."_RctPgCh") then params:set("S"..i.."_Rct",1-params:get("S"..i.."_Rct"))
